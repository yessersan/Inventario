                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                <option value="repotenciación" {{ old('type') == 'repotenciación' ? 'selected' : '' }}>Repotenciación</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="next_maintenance" id="next_maintenance" class="form-control @error('next_maintenance') is-invalid @enderror" value="{{ old('next_maintenance') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="performed_by" id="performed_by" class="form-select @error('performed_by') is-invalid @enderror">
                                ...
                                @foreach($personnel as $p)
                                    <option value="{{ $p->id }}" {{ old('performed_by') == $p->id ? 'selected' : '' }}>{{ $p->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="cost" id="cost" class="form-control @error('cost') is-invalid @enderror" value="{{ old('cost') }}" min="0">
